...
def get_question(flag):
    ...
    # For the options to not get placed in the same place over and over again until you can just press the options without even looking, which would then stall our improvement. In that way options get mixed between available ones so option a, b, c and d.
